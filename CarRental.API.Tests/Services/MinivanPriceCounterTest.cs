...
{
    public class MinivanPriceCounterTest
    {
        IPriceCounter _testObject { get; set; }

        public MinivanPriceCounterTest()
        {
            _testObject = new MinivanPriceCounter();
        }
